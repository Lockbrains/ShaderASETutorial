	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (V2FData i ) : SV_Target
			{
				...
				finalColor = float4( texCoord1, 0.0 , 0.0 );
				return finalColor;
			}
			ENDCG
		}
