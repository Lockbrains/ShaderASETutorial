...
{
    float uvScale = 12;
    float caustic = Voronoi3D(pos*uvScale +float3(0.2,0,0.2) - float3(1,0,1)*_Time.y);
    float caustic2 = Voronoi3D(pos*uvScale +float3(0.1,0,0.1) - float3(1,0,1)*_Time.y);
    float caustic3 = Voronoi3D(pos*uvScale - float3(0.1,0,0.1)- float3(1,0,1)*_Time.y);
